...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${request.contextPath}/static/css/base.css" media="all">
    <link rel="stylesheet" type="text/css"
          href="${request.contextPath}/static/css/plist20131112.css" media="all">
    <link rel="stylesheet" type="text/css"
          href="${request.contextPath}/static/css/list-page-20141009.css" media="all">
    <link rel="stylesheet" type="text/css"
          href="${request.contextPath}/static/css/pop_compare.css" media="all">
...
<div id="o-header-2013">
    <div class="w" id="header-2013">
        <div id="logo-2013" class="ld"><a href="http://www.jd.com/" hidefocus="true"><b></b><img
                src="${request.contextPath}/static/img/logo-201305.png" width="270" height="60" alt="京东"></a></div>
        <!--logo end-->
        <div id="search-2013">
            <div class="i-search ld">
                <ul id="shelper" class="hide"></ul>
                <form id="actionForm" action="${request.contextPath}/list" method="POST">
                    <div class="form">
    ...
    <div class="right-extra">
        ...
        <div id="plist" class="m plist-n7 plist-n8 prebuy">
            ...
            <#if result??>
                ...
                <#list result.productList as item>
                    <li pid="${item.pid }">
                        <div class="lh-wrap">
                            <div class="p-img">
                                <a target="_blank" href="#">
                                    <img width="220" height="282" class="err-product"
                                         src="${request.contextPath}/static/img/items/${item.picture}">
                                </a>
                            </div>
                            <div class="p-name">
                            ...
                            <div class="p-price">
                                <strong>￥
                                    ${item.price}
                                </strong><span id="p1269191543"></span>
                            </div>
                        </div>
                    </li>
                </#list>
...
<div class="w">
    <div id="footer-2013">
        ...
        <div class="authentication"><a rel="nofollow" target="_blank"
                ...
                width="108" height="40" alt="经营性网站备案中心" src="${request.contextPath}/static/img/108_40_zZOKnl.gif"
                class="err-product"></a>
            <a rel="nofollow" target="_blank" tabindex="-1"
               ...
               id="urlknet"><img width="108" height="40" border="true"
                                 ...
                                 src="${request.contextPath}/static/img/kxwz.gif"
                                 class="err-product"></a>
            <a rel="nofollow" target="_blank"
               href="http://www.bj.cyberpolice.cn/index.do"><img width="108"
                                                                 height="40" alt="朝阳网络警察"
                                                                 src="${request.contextPath}/static/img/cywljc.png"
                                                                 class="err-product"></a>
            <a rel="nofollow" target="_blank"
               href="https://search.szfw.org/cert/l/CX20120111001803001836"><img
                    width="112" height="40"
                    src="${request.contextPath}/static/img/112_40_WvArIl.png"
                    class="err-product"></a>
        </div>
    </div>
</div>
